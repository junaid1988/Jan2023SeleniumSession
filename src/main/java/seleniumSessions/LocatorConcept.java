...
//		
		...
		//4. xpath: its not an attribute. its the address of element in HTML DOM
...
//		
		...
		//5. css selesctor: its not an attribute
...
//		driver.findElement(By.cssSelector("#content > form > div > div > input.btn.btn-primary")).click();
		...
		//xpath vs css selector? both have advantages and disadvantages 
		//css = Cascading style sheet is used for the local field
